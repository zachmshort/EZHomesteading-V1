...
const footerNavigation = {
  shop: [
    { name: 'Highly Perishable', href: '/' },
    { name: 'Perishable', href: '/' },
    { name: 'Less Perishable', href: '/' },
    { name: 'Non-Perishable', href: '/' },
    { name: 'Non-Consumable', href: '/' },
  ],
  company: [
          ...
          >
            ...
            <div className="mt-10 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
              {collections.map((collection) => (
                <Link to={collection.href} className="group block cursor-auto mb-4 mr-4">
                  <div
                    aria-hidden="true"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
              ...
              <div className="mt-12 md:mt-16 xl:mt-0">
                ...
                <p className="mt-6 text-sm text-gray-300">Get updates on popular produce in your area and more.</p>
